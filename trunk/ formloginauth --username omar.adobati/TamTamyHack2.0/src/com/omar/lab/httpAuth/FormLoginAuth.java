...
public class FormLoginAuth extends HttpClient
{
	...
	public FormLoginAuth(Props p){
		...
		if((username==null || username.equals("")) || 
		   (password==null || password.equals(""))){			
			System.out.println("ERROR: NO USERNAME OR PASSWORD");
			System.exit(0);
		}
		
		if((contentPage==null || contentPage.equals("")) || 
		   (logonSite==null || logonSite.equals("")) ||
		   (loginUrl==null || loginUrl.equals("")) ||			
	...
	public String doPostRequest(String url, boolean getResponse, HashMap params) throws HttpException, IOException{
		...
		postReq.setRequestBody((NameValuePair[]) hashMapToNameValuePairs(params));
